  ...
  <div class="shop_record_list">
    ...
    <div class="list">
      <el-table :data="goods_info" height="650" border style="width: 100%">
        ...
        <el-table-column prop="e_time" label="出售时间" align="center">
        </el-table-column>
        <el-table-column prop="seller" label="出售者" align="center">
        </el-table-column>
        <el-table-column prop="buyer" label="购买者" align="center">
        </el-table-column>
